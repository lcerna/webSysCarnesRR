...
{
    public class SFRRMBEN11DA
    {
        public List<SFRRMBEN11> obtenerDatosId(string GuiaRD_Codi)
        {
            List<SFRRMBEN11> objSFRRMBEN11 = new List<SFRRMBEN11>();
        ...
        public void insertarRegistro(SFRRMBEN11 objSFRRMBEN11)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(Configuracion.conexion))
        ...
        private SFRRMBEN11 llenarObjeto(SqlDataReader dr)
        {
            SFRRMBEN11 objSFRRMBEN11 = new SFRRMBEN11();
            objSFRRMBEN11.GuiaRD_Codi = Convert.ToInt32(dr["GuiaRD_Codi"]);
            objSFRRMBEN11.GuiaR_Numero = Convert.ToString(dr["GuiaR_Numero"]);
            objSFRRMBEN11.NroMovimiento = Convert.ToString(dr["NroMovimiento"]);
            objSFRRMBEN11.Ped_Codigo = Convert.ToString(dr["Ped_Codigo"]);
            objSFRRMBEN11.Bie_Codigo = Convert.ToString(dr["Bie_Codigo"]);
            objSFRRMBEN11.GuiaRD_Cantidad = Convert.ToInt32(dr["GuiaRD_Cantidad"]);
            objSFRRMBEN11.GuiaRD_Adicional = Convert.ToString(dr["GuiaRD_Adicional"]);
            objSFRRMBEN11.GuiaR_Nuevo_Usuario = Convert.ToString(dr["GuiaR_Nuevo_Usuario"]);
            objSFRRMBEN11.GuiaR_Nuevo_Fecha = Convert.ToDateTime(dr["GuiaR_Nuevo_Fecha"]);
            objSFRRMBEN11.Usu_Upd = Convert.ToString(dr["Usu_Upd"]);
            objSFRRMBEN11.Fec_Upd = Convert.ToDateTime(dr["Fec_Upd"]);  
