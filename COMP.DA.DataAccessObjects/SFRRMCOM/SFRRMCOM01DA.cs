...
{
    public class SFRRMCOM01DA
    {
        public List<SFRRMCOM01> obtenerDatosId(string codigo)
        {
            List<SFRRMCOM01> objSFRRMBEN12 = new List<SFRRMCOM01>();
        ...
        public void insertarRegistro(SFRRMCOM01 objSFRRMBEN12)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(Configuracion.conexion))
        ...
        public void actualizarRegistro(SFRRMCOM01 objSFRRMBEN11)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(Configuracion.conexion))
        ...
        private SFRRMCOM01 llenarObjeto(SqlDataReader dr)
        {
            SFRRMCOM01 objSFRRMBEN12 = new SFRRMCOM01();/*
