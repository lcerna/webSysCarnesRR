<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas.master" AutoEventWireup="true" CodeFile="frmOpcionesSistema.aspx.cs" Inherits="pages_Beneficio_Proveedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <h1>
        ...
        <small>Registro de Opciones </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li><a href="#">Administrador</a></li>
        <li class="active">Mantenimiento</li>
          <li class="active">Opciones Sistema</li>
      </ol>
    </section>
  <br />
    <div class="col-md-12">
   <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Mantenimiento Opciones del Sistemas</h3>
            </div>
            <div class="box-body">
                 <div class="row">
                <div class="col-xs-2">
                ...
                <div class="btn btn-group-justified">
                     <div class="box-footer">
                                <asp:Button ID="btnNuevo3" runat="server" Text="Nuevo" CssClass=" btn btn-primary" />
                                <asp:Button ID="btnGuardar3" runat="server" Text="Guardar" CssClass="btn btn-primary" Enabled="False"  />
                                <asp:Button ID="btnEliminar3" runat="server" Text="Eliminar" CssClass="btn btn-primary" Enabled="False"  />
                                <asp:Button ID="btnCancelar3" runat="server" Text="Cancelar" CssClass="btn btn-primary" />
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="box-body">
                     ...
                     <asp:GridView ID="dgvAlmacenes" runat="server" DataKeyNames="CodAlmacen" UseAccessibleHeader="False" Width="100%" CssClass="table table-bordered table-hover" > <%--OnPageIndexChanging="dgvAlmacenes_PageIndexChanging" PageSize="5" AllowPaging="true" AllowSorting="true" >--%>
