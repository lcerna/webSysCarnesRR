<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas.master" AutoEventWireup="true" CodeFile="frmTipoCambio.aspx.cs" Inherits="pages_Beneficio_Proveedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <h1>
        Tipo de Cambio
        <small>Registro de Tipo de Cambio</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body">
                ...
                <div class="btn btn-group-justified">
                     <div class="box-footer">
                                ...
                                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="btn btn-primary" Enabled="False" />
