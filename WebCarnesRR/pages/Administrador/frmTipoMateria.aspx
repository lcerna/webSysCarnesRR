<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas.master" AutoEventWireup="true" CodeFile="frmTipoMateria.aspx.cs" Inherits="pages_Administrador_frmTipoMateria" %>
            ...
            <div class="box-body">
                ...
                <div class="btn btn-group-justified">
                     <div class="box-footer">
                                <asp:Button ID="btnNuevo1" runat="server" Text="Nuevo" CssClass=" btn btn-primary" />
                                <asp:Button ID="btnGuardar2" runat="server" Text="Guardar" CssClass="btn btn-primary" Enabled="False" />
