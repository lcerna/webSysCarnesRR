...
public partial class pages_Ventas_Cliente : System.Web.UI.Page
{
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        txtCodigo.Text  = txtNombre.Text = txtDirec.Text = txtEmail.Text = txtNumDoc.Text = txtNumTel.Text = txtAlmacen.Text = txtPrefProv.Text = txtObserva.Text = String.Empty;
    ...
    protected void btnCancelar_Click(object sender, EventArgs e)
    {
        ...
        txtCodigo.Text  = txtNombre.Text = txtDirec.Text = txtEmail.Text = txtNumDoc.Text = txtNumTel.Text = txtObserva.Text = String.Empty;
        cmbTipDoc.SelectedValue = "0";
        dblTipTelf.SelectedValue = "0";
        cmbDepa.SelectedValue = "0";
        cmbProv.SelectedValue = "0";
